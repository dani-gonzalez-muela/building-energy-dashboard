...
with tab1:
    ...
    st.caption("Buildings with highest combination of anomaly flags, efficiency gaps, and baseload.")
    ...
    if os.path.exists(PLOTS_PATH):
        ...
        with col1:
            if os.path.exists(f"{PLOTS_PATH}/consumption_distribution.png"):
                ...
                st.caption("Most buildings cluster in lower consumption ranges.")
        ...
        with col2:
            if os.path.exists(f"{PLOTS_PATH}/weekend_vs_weekday.png"):
                ...
                st.caption("Gap indicates shutdown efficiency.")
        ...
        st.warning(f"📁 Plots folder not found.")
        st.info("Add a `plots/` folder with EDA images to see visualizations.")

# =============================================================================
# TAB 3: Building Explorer
# =============================================================================

with tab3:
    st.header("🔍 Building Explorer")
    st.caption("Explore details for priority buildings.")
    ...
    if selected:
        ...
        if building:
            ...
            with col2:
                ...
                if cluster_data:
                    st.metric("Avg Baseload", f"{cluster_data.get('avg_baseload', 0):.1f} kWh",
            ...
            with col3:
                ...
                night_ratio = building.get('night_ratio')
                if night_ratio:
                    st.write(f"**Night Ratio:** {night_ratio:.2f}")
            ...
            if shap_values:
                ...
                st.caption("🔴 Red = increases prediction | 🟢 Green = decreases prediction")
